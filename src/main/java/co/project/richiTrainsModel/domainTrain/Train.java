...
public class Train {
    ...
    public Train(String name, String referencia, TipoTrain tipo, boolean inRoad, float kilometraje, boolean isEnabled) {
        this.name = name;
    ...
    public String toString() {
        return "Train{" +
                ...
                ", vagonesPasajeros=" + vagonesPasajeros +
                ", vagonesEquipaje=" + vagonesEquipaje +
                '}';
    }
}
